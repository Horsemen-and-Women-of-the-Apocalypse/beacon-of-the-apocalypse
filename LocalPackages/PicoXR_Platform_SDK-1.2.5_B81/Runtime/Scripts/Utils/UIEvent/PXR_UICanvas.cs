...
public class PXR_UICanvas : MonoBehaviour
{
    ...
    protected virtual void SetupCanvas()
    {
        ...
        var customRaycaster = canvas.gameObject.GetComponent<PXR_UIGraphicRaycaster>();
        if (!customRaycaster)
        {
            customRaycaster = canvas.gameObject.AddComponent<PXR_UIGraphicRaycaster>();
        }
